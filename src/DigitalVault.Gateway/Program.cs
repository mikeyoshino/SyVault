...
// Config Data Protection to persist keys to file system
// This ensures cookies are valid across server restarts
builder.Services.AddDataProtection()
    .PersistKeysToFileSystem(new DirectoryInfo(Path.Combine(builder.Environment.ContentRootPath, "keys")))
    .SetApplicationName("HeritageVault");
...
// Only use HTTPS redirection in production (disabled for dev to allow HTTP access with HTTP-only MinIO)
if (!app.Environment.IsDevelopment())
{
